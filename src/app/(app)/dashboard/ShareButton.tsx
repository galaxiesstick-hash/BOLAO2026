...
const SHARE_OPTIONS = [
  {
    ...
    getUrl: () =>
      `https://wa.me/?text=${encodeURIComponent(INVITE_TEXT)}`,
  },
  {
    id: "telegram",
    label: "Telegram",
    ...
    getUrl: () =>
      `https://t.me/share/url?url=${encodeURIComponent(SITE_URL)}&text=${encodeURIComponent(INVITE_TEXT)}`,
  },
  {
    id: "copy",
    label: "Copiar link",
        ...
        >
          <div
            style={{
              ...
              background: "linear-gradient(180deg, #15263f 0%, #0d1f36 100%)",
          ...
          >
            ...
            <div style={{
              ...
              <div style={{ padding: "20px 20px 16px", position: "relative", textAlign: "center" }}>
                ...
                <div style={{
                  ...
                  fontSize: 26, letterSpacing: 2, color: "#C9A84C", lineHeight: 1,
                }}>
                  BOLÃO LAMPARÃO
                </div>
                <div style={{ fontSize: 12, color: "rgba(231,238,250,0.5)", marginTop: 3, letterSpacing: 0.5 }}>
                  COPA DO MUNDO 2026
                </div>
                ...
                <div style={{
                  ...
                  color: "rgba(231,238,250,0.7)", lineHeight: 1.7,
            ...
            {/* Title */}
            <div style={{ fontSize: 11, fontWeight: 700, color: "rgba(231,238,250,0.38)", letterSpacing: 1, textTransform: "uppercase", marginBottom: 12 }}>
              Compartilhar via
            </div>
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      border: `1px solid ${isCopied ? opt.color + "55" : "rgba(255,255,255,0.08)"}`,
                      color: isCopied ? opt.color : "#f3f6fb",
                      fontWeight: 600, fontSize: 13,
                      cursor: "pointer", transition: "all 0.2s",
                      textAlign: "left",
                    }}
                  >
                    <span style={{ color: isCopied ? opt.color : opt.color, opacity: isCopied ? 1 : 0.85, flexShrink: 0 }}>
                      {opt.icon}
                    </span>
            ...
            <button
              ...
              style={{
                ...
                color: "rgba(231,238,250,0.5)", fontWeight: 600, fontSize: 13,
                cursor: "pointer",
              }}
            >
              Cancelar
